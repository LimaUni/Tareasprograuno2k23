...
using namespace std;
    ...
    const int NUMERO_CANDIDATOS1 = 5;
    const int NUMERO_CANDIDATOS2 = 5;
    const int NUMERO_CANDIDATOS3 = 5;
    const int NUMERO_ANIOS = 4;
    const int MAX_ACTIVIDADES = 20;
    const int MAX_CALIFICACION_2017 = 1000000;
    const int MAX_CALIFICACION_2019 = 1000000;
    const int MAX_CALIFICACION_2021 = 1000000;
    ...
    const char PARTIDOS = 3;

int busquedaAleatorios(int minimo, int maximo);
void llenarMatriz1(float matriz[NUMERO_CANDIDATOS1][NUMERO_ANIOS + 1]);
void llenarMatriz2(float matriz[NUMERO_CANDIDATOS2][NUMERO_ANIOS + 1]);
void llenarMatriz3(float matriz[NUMERO_CANDIDATOS3][NUMERO_ANIOS + 1]);
void imprimirMatrizLinea();
void imprimirMatriz1(float matriz1[NUMERO_CANDIDATOS1][NUMERO_ANIOS + 1], char alumnos[NUMERO_CANDIDATOS1][MAXIMA_LONGITUD_CADENA]);
void imprimirMatriz2(float matriz2[NUMERO_CANDIDATOS2][NUMERO_ANIOS + 1], char alumnos[NUMERO_CANDIDATOS2][MAXIMA_LONGITUD_CADENA]);
void imprimirMatriz3(float matriz3[NUMERO_CANDIDATOS3][NUMERO_ANIOS + 1], char alumnos[NUMERO_CANDIDATOS3][MAXIMA_LONGITUD_CADENA]);
int main()
{
    srand(getpid());
    float matriz1[NUMERO_CANDIDATOS1][NUMERO_ANIOS + 1];
    float matriz2[NUMERO_CANDIDATOS2][NUMERO_ANIOS + 1];
    float matriz3[NUMERO_CANDIDATOS3][NUMERO_ANIOS + 1];
    char alumnos1[NUMERO_CANDIDATOS1][MAXIMA_LONGITUD_CADENA] = {"Giamattei","Jimmy","Cabrera","Molina","Colon"};
    char alumnos2[NUMERO_CANDIDATOS2][MAXIMA_LONGITUD_CADENA] = {"Arjona","Moreno","Estrada","Villa","Lima"};
    char alumnos3[NUMERO_CANDIDATOS3][MAXIMA_LONGITUD_CADENA] = {"Aguilar","Batres","Ixcoy","Cardenas","Arbenz"};
...
void llenarMatriz1(float matriz1[NUMERO_CANDIDATOS1][NUMERO_ANIOS + 1])
{
    int y, x;
...
void llenarMatriz2(float matriz2[NUMERO_CANDIDATOS2][NUMERO_ANIOS + 1])
{
    int y, x;
